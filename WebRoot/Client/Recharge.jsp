...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>充值中心-US云打印</title>
    <script type="text/javascript" src=""></script>
	<link rel="stylesheet" type="text/css" href="Client/css/Recharge.css">
  </head>
  <body>
   ...
   <div class="head">
       <div class="head_middle_part">
             ...
             <div class="head_inner_second weiruanyahei">
               ...
               <p class="align-left align-bottom" style="margin-left:22px;margin-bottom:-2px;"><a class="black_orange" href="">充值中心</a></p>
             </div> 
        ...
        <div class="main_middle_part">
           <!--   <div class="main_middle_part_up "> 
              ...
              <div class="main_middle_part_low"> 
                 <div class="recharge_ways">
                     <iframe src="Client/comSrc/luyu_frames/recharge.html" width="100%" height="640px"  frameborder="0" scrolling="no" ></iframe>
                 </div> 
              </div>
        </div>
   </div>
