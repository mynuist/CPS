        ...
        <div class="main_middle_part">
            <!-- <div class="main_middle_part_up "> 
              ...
              <div class="main_middle_part_low"> 
                 <div class="orderlist">
                     <iframe id="autoframe" src="Client/comSrc/luyu_frames/luyu_order_page.jsp" width="980" height="360" id="loginIframe" frameborder="0" scrolling="no"  onload="frameloaded()"></iframe>
                 </div> 
              </div>
        </div>
   </div>
