...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>订单详情-US云打印</title>
    <script type="text/javascript" src=""></script>
	<link rel="stylesheet" type="text/css" href="Client/css/OrderDetail.css">
  </head>
  <body>
   ...
   <div class="head">
       <div class="head_middle_part">
             ...
             <div class="head_inner_second weiruanyahei">
               ...
               <p class="align-left align-bottom" style="margin-left:22px;margin-bottom:-2px;"><a class="black_orange" href="">订单中心</a></p>
             </div> 
   ...
   <div class="main">
        <div class="main_middle_part">
            <!--  <div class="main_middle_part_up "> 
                                                      订单中心&nbsp;&gt;&gt;&nbsp;订单详情&nbsp;&gt;&gt;&nbsp;KB02014032
              </div> -->
              <div class="main_middle_part_low"> 
                 <div class="orderlist">
                        <iframe src="Client/comSrc/order_detail/order_detail.html"  width="980px
                        " height="700px"  frameborder="0" scrolling="no"></iframe> 
                 </div> 
              </div>
        </div>
   </div>
