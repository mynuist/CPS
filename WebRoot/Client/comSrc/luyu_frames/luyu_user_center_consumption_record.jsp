...
String order_ctnt[][] = {
		{"2014-01-02 12:22:11","16K纸正反面打印+1份+封面","-5.8","交易成功","<a href=''style='color:blue'>详情</a>"},
		{"2014-01-02 12:22:11","海报+彩印+1份+送货","-13.2","交易成功","<a href='' style='color:blue'>详情</a>"}
};
  ...
  <body>
    <div id="order_field">
    	<div id="order_top_index">
    		...
    		<a href="<%=pagePath %>luyu_user_center_consumption_record.jsp" style="background-color:#f6f6f6;">消费记录</a>
    		<a href="<%=pagePath %>luyu_user_center_charge_record.jsp">充值记录</a>
    	</div>
    	...
    	<div id="order_ctnt_field">
    		...
    		<div id="order_ctnt_list">
    			<div class="order_ctnt_list_item" style="height:24px;">
    				<div class="order_ctnt_list_item_top_1">消费时间</div>
    				<div class="order_ctnt_list_item_top_2">打印产品</div>
